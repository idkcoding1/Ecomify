          ...
          children: [
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  CategoryTile('Laptops', Icons.laptop, context),
                  CategoryTile('Accessories', Icons.headset, context),
                  CategoryTile('Mobiles', Icons.phone_android, context),
                  CategoryTile('Smartwatch', Icons.watch, context),
                ],
              ),
            ),
          ],
